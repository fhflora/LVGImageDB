...
public class ReadThread extends Thread{
	...
	public ReadThread(String threadName, BigImgManage bigImageManage, long nImgID) {
		super(threadName);
	...
	public Hashtable<Integer, byte[]> getBlockBuf() {
		...
		for (Iterator<Entry<Integer, byte[]>> it = BlockBuf.entrySet().iterator();
			 it.hasNext();) {
	...
	public int getBlocksForDisplay() {
		...
		// 删除不需要的瓦片
		for (Iterator<Entry<Integer, byte[]>> it = tempBlockBuf.entrySet().iterator(); it.hasNext();) {
