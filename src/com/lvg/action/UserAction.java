...
public class UserAction extends ActionSupport implements SessionAware {
	...
	public String userLogin() {
		...
		if (!certCode.equals(ServletActionContext.getRequest().getSession()
				.getAttribute("rand"))) {
		...
		if (userManage.loginCheck(userInfo.getUserName(),
				userInfo.getPassword(), userInfo.getUserType()) != -1) {
			userInfo = (UserInfo) userManage.getUserInfo(userManage.loginCheck(
	...
	public String modifyUserInfoClient() {
